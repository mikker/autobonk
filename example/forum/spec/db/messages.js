...
const encoding6 = {
  preencode (state, m) {
    ...
    c.buffer.preencode(state, m.authorKey)
  ...
  encode (state, m) {
    ...
    c.buffer.encode(state, m.authorKey)
...
const encoding13 = {
  preencode (state, m) {
    c.string.preencode(state, m.userKey)
    c.string.preencode(state, m.role)
  },
  encode (state, m) {
    c.string.encode(state, m.userKey)
...
const encoding14_4 = encoding1_4
...
const encoding14 = {
  preencode (state, m) {
    ...
    if (m.roles) encoding14_4.preencode(state, m.roles)
    if (m.createdBy) c.buffer.preencode(state, m.createdBy)
    if (m.createdAt) c.uint.preencode(state, m.createdAt)
    if (m.revokedAt) c.uint.preencode(state, m.revokedAt)
  },
  encode (state, m) {
    ...
    if (m.roles) encoding14_4.encode(state, m.roles)
    if (m.createdBy) c.buffer.encode(state, m.createdBy)
    if (m.createdAt) c.uint.encode(state, m.createdAt)
    if (m.revokedAt) c.uint.encode(state, m.revokedAt)
  },
  decode (state) {
    ...
    return {
      ...
      publicKey: r2,
      expires: r3,
      roles: (flags & 1) !== 0 ? encoding14_4.decode(state) : null,
      createdBy: (flags & 2) !== 0 ? c.buffer.decode(state) : null,
      createdAt: (flags & 4) !== 0 ? c.uint.decode(state) : 0,
      revokedAt: (flags & 8) !== 0 ? c.uint.decode(state) : 0
    }
...
const encoding17_1 = encoding1_4

// @autobonk/role-def/hyperdb#3
const encoding17 = {
  preencode (state, m) {
    encoding17_1.preencode(state, m.permissions)
    c.uint.preencode(state, m.rev)
    c.uint.preencode(state, m.index)
    c.uint.preencode(state, m.timestamp)
  },
  encode (state, m) {
    encoding17_1.encode(state, m.permissions)
    c.uint.encode(state, m.rev)
    c.uint.encode(state, m.index)
    c.uint.encode(state, m.timestamp)
  },
...
const encoding18_1 = encoding1_4

// @autobonk/acl-entry/hyperdb#4
const encoding18 = {
  preencode (state, m) {
    encoding18_1.preencode(state, m.roles)
    c.uint.preencode(state, m.rev)
    c.uint.preencode(state, m.index)
    c.uint.preencode(state, m.timestamp)
  },
  encode (state, m) {
    encoding18_1.encode(state, m.roles)
    c.uint.encode(state, m.rev)
    c.uint.encode(state, m.index)
    c.uint.encode(state, m.timestamp)
  },
...
function getEncoding (name) {
  switch (name) {
    ...
    case '@forum/post': return encoding6
    case '@forum/comment': return encoding7
    case '@forum/create-post': return encoding8
    case '@forum/delete-post': return encoding9
    case '@forum/create-comment': return encoding10
    case '@forum/delete-comment': return encoding11
    case '@forum/setup-roles': return encoding12
    case '@forum/promote-user': return encoding13
    case '@autobonk/invite/hyperdb#0': return encoding14
    case '@autobonk/writer/hyperdb#1': return encoding15
    case '@autobonk/context-init/hyperdb#2': return encoding16
    case '@autobonk/role-def/hyperdb#3': return encoding17
    case '@autobonk/acl-entry/hyperdb#4': return encoding18
    case '@forum/post/hyperdb#5': return encoding19
    case '@forum/comment/hyperdb#6': return encoding20
